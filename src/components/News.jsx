  ...
  articles = [
    {
      ...
      title:
        "Stuart Broad lands unwanted record by getting smashed for Test cricket’s most expensive over in history a...",
      description: "",
      url: "https://talksport.com/sport/cricket/1141653/stuart-broad-record-over-england-india-test/",
      urlToImage:
        "https://talksport.com/wp-content/uploads/sites/5/2022/07/crop-1141691.jpg?strip=all&quality=100&w=1920&h=1080&crop=1",
...
// --life cycle method
  async componentDidMount() {
    let url = "https://newsapi.org/v2/top-headlines?country=in&apiKey=db1a201e0e1f4f1793d7c37f91cd7b5d";
